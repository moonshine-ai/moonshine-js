...
// MoonshineSettings.FRAME_SIZE = 125;
    ...
    transcriber = new StreamTranscriber(
        {
            ...
            onTranscriptionCommitted: function (text) {
                ...
                // NOTE: since this is an offscreen script, we can only use the chrome.runtime API, which
                // cannot be used to communicate directly with the content script :)
